...
$DefaultPasswords['admin'] = crypt('impossible hidden danger');
$DefaultPasswords['edit']  = crypt('abide');
...
$EnableUpload = 1;
# $UploadPermAdd = 0;
$DefaultPasswords['upload'] = crypt('impossible hidden danger');
